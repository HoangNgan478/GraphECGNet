...
os.makedirs(os.path.join(args.root, "weights"), exist_ok=True)
...
for epoch in range(1, args.epochs):
    ...
    if val_acc > best_val_acc:
        ...
        save_weight_path = osp.join(args.root, "weights", f"Graph_{args.layer_name}_{args.training_dataset_name}_best.pth")
...
#plt.show()
plt.savefig(osp.join(args.root, "results", f"Evolution_training_{args.layer_name}_{args.training_dataset_name}.png"))
