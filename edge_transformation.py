...
sourcedir = '/kaggle/working/ptbxl_processed/train/'
destdir   = '/kaggle/working/edges_prewitt_v1/train/'

os.makedirs(destdir, exist_ok=True)
print("The new directory is created!")

for folder in os.listdir(sourcedir):
    src = os.path.join(sourcedir, folder)
    dst = os.path.join(destdir, folder)
    os.makedirs(dst, exist_ok=True)
    converter_Prewitt_v1(src, dst)
